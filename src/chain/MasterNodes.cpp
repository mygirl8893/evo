...
//master nodes
bool Node::send_of_deposit(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::cryptonoted::CheckSendDeposit::Request &&request, api::cryptonoted::CheckSendDeposit::Response &response) {
